...
# 配置文件路径
cfg_file = "/home/ncistwlwsys/hezhizhou-projects/Open3D-ML/ml3d/configs/pointpillars_kitti.yml"
# 加载配置文件
...
# 设置数据集路径
cfg.dataset['dataset_path'] = "/home/ncistwlwsys/hezhizhou-projects/disk/Kitti"
# 创建数据集
