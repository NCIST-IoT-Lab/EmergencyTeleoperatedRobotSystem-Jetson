...
# 设置数据集路径
cfg.dataset['dataset_path'] = "/home/ncistwlwsys/hezhizhou-projects/disk/S3DIS/Stanford3dDataset_v1.2_Aligned_Version"
# 创建数据集
dataset = ml3d.datasets.S3DIS(cfg.dataset.pop(
    'dataset_path', None), **cfg.dataset)
# 创建 pipeline
...
#     "/home/ncistwlwsys/hezhizhou-projects/disk/SingleAzureKinect3DReconstruction/src/python/data_s3dis.ply", pcd)
