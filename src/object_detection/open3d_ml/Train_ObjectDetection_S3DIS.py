...
cfg_file = "/home/ncistwlwsys/hezhizhou-projects/disk/SingleAzureKinect3DReconstruction/src/python/configs/train_pointpillars_s3dis.yml"
...
dataset = ml3d.datasets.S3DIS(dataset_path=path, use_cache=True)
